...
class WC_PayKings_License_Updates {

	const SECRET_KEY = '5b34ae90764af4.57283112';
	const SERVER_URL = 'https://pledgedplugins.com';
	const LONG_NAME = 'WooCommerce PayKings Gateway (Pro)';
	const SHORT_NAME = 'WooCommerce PayKings';
	const VAR_IDS = '4902,6695,6696,15194';
	const PLUGIN_SLUG = 'paykings-payment-woocommerce';
	...
	public static function get_instance() {
		if ( self::$_instance == null ) {
			self::$_instance = new WC_PayKings_License_Updates();
		}
...
WC_PayKings_License_Updates::get_instance();