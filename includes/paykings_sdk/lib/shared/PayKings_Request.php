<?php
/**
 * Sends requests to the PayKings gateways.
 *
 * @package    PayKings Payment
 * @subpackage PayKings_Request
 */
abstract class PayKings_Request {
    ...
    public function __construct( $_username = false, $_password = false, $_logging = false ) {
        ...
        $this->_sandbox = ( defined( 'PAYKINGS_SANDBOX' ) ? PAYKINGS_SANDBOX : true );
        $this->_log_file = ( defined( 'PAYKINGS_LOG_FILE' ) ? PAYKINGS_LOG_FILE : false );
    }
    ...
    /**
     * Posts the request to PayKings Payment & returns response.
     *
     * @return PayKings_Response The response.
     */
